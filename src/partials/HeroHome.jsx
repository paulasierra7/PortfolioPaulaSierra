    ...
    <section className="relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div>
              <img className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" src="https://avatars.githubusercontent.com/u/65257680?s=400&v=4" style={{borderRadius: '80%'}} width={'20%'} height={'20%'} alt="Profile Picture"></img>
              <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">
                Paula Sierra's <br></br> <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">Portfolio</span>
              </h1>
          </div>
