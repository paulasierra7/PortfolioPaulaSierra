      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">React.js Developer Projects</h1>
            <p className="text-xl text-gray-600">After graduating from the online classes of HTML,CSS, Javascript and React I have created the following projects:</p>
          </div>
